    ...
    def fetch_and_store_orders(
        ...
        try:
            ...
            for idx, order in enumerate(unique_orders, 1):
                ...
                # 🆕 TARİH KONTROLÜ - ±1 gün tolerans, ama aralık dışındakileri uyar
